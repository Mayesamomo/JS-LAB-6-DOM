...
function pageReady(){
	...
	// Create the additional JS code to grab these elements, then set up listeners 
	// to handle the mouseover/mouseout events that will complete this gallery with all six images.
